...
function POS() {
  ...
  this.clearNNP = function() {
    var incast = ['Brad', 'Culpepper', 'Aubry', 'Aubry',
      'Cirie', 'Tai', 'Cirie', 'Tai',
      'Sarah', 'Troyzan', 'Sarah', 'Troyzan'
    ];
    var outcast = ['Probst', 'Probst', 'Jeff Probst', 'Jeff Probst',
      'Probst', 'Probst', 'Jeff Probst', 'Jeff Probst',
      'Michaela', 'Andrea', 'Sierra', 'Zeke', 'Hali', 'Ozzy', 'Debbie'
    ];
