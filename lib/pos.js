...
function POS() {
  ...
  this.clearNNP = function() {
    var incast = ['Andrea', 'Brad', 'Culpepper', 'Aubry', 'Ciera', 'JT',
      'Cirie', 'Jeff', 'Varner', 'Debbie', 'Hali', 'Ozzy', 'Michaela', 'Tai',
      'Sandra', 'Sarah', 'Troyzan', 'Sierra', 'Zeke'
    ];
    var outcast = ['Jeff', 'Jeff Probst'];
    var eliminated = ['Ciera', 'Tony', 'Caleb', 'Malcolm'];
    this.dict['PERSON'] = [];
